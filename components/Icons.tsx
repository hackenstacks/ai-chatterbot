...
export const ImageIcon: React.FC = () => (
    // FIX: Corrected a malformed viewBox attribute which was causing parsing errors.
...
export const FilesIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15.5 2H8.6c-.4 0-.8.2-1.1.5-.3.3-.5.7-.5 1.1V14c0 .8.6 1.4 1.4 1.4h9.8c.8 0 1.4-.6 1.4-1.4V6.5L15.5 2z"></path><path d="M3 7.6v12.8c0 .8.6 1.4 1.4 1.4h9.8"/><path d="M15 2v5h5"/></svg>
);
...
export const BrainCircuitIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a2.5 2.5 0 0 1 3 4" /><path d="M12 2a2.5 2.5 0 0 0-3 4" /><path d="M15 6a2.5 2.5 0 0 1 4 3" /><path d="M15 6a2.5 2.5 0 0 0-4 3" /><path d="M9 6a2.5 2.5 0 0 1-4 3" /><path d="M9 6a2.5 2.5 0 0 0 4 3" /><path d="M5 9a2.5 2.5 0 0 1 0 6" /><path d="M19 9a2.5 2.5 0 0 1 0 6" /><path d="M12 13a2.5 2.5 0 0 1-3 4" /><path d="M12 13a2.5 2.5 0 0 0 3 4" /><path d="M9 18a2.5 2.5 0 0 1-4 3" /><path d="M9 18a2.5 2.5 0 0 0 4 3" /><path d="M15 18a2.5 2.5 0 0 1 4 3" /><path d="M15 18a2.5 2.5 0 0 0-4 3" /><path d="M12 6a2.5 2.5 0 0 1-1 2" /><path d="M12 6a2.5 2.5 0 0 0 1 2" /><path d="M12 18a2.5 2.5 0 0 1 1-2" /><path d="M12 18a2.5 2.5 0 0 0-1-2" /><circle cx="12" cy="12" r="2" /></svg>
);

export const SparklesIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L9.5 9.5 3 12l6.5 2.5L12 21l2.5-6.5L21 12l-6.5-2.5L12 3z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>
);

export const RadioTowerIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4.5 13.5c3-3 6-3 9 0"/><path d="M6.5 11.5c2-2 4-2 6 0"/><path d="M8.5 9.5c1-1 2-1 3 0"/><path d="M12 7.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"/><path d="M12 22V15"/><path d="m9 15 3-3 3 3"/><path d="M17 15h-2.5a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5H17"/><path d="M7 15h2.5a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5H7"/></svg>
);
...
export const ArchiveIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="5" rx="1"/><path d="M4 9v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9"/><path d="M10 13h4"/></svg>
);
...
export const Volume1Icon: React.FC = () => (
...
export const Volume2Icon: React.FC = () => (
